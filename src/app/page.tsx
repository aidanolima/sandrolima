...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground font-sans">
      ...
      <section id="why" className="py-24 bg-surface-lowest">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Card 1 */}
            <div className="bg-surface-low border border-foreground/5 rounded-xl p-8 hover:border-[#ccff00]/20 hover:shadow-[0_0_30px_rgba(204,255,0,0.06)] hover:-translate-y-1 transition-all">
              <div className="w-12 h-12 rounded-lg bg-[#ccff00]/10 flex items-center justify-center text-2xl mb-5">📈</div>
              <h3 className="font-grotesk text-lg font-semibold text-foreground mb-2">Maximização de ROI</h3>
              <p className="text-foreground/70 text-sm leading-relaxed">Cada real investido é rastreado. Acompanhamos seu retorno em tempo real e ajustamos as campanhas para performance máxima.</p>
            </div>
            {/* Card 2 */}
            <div className="bg-surface-low border border-foreground/5 rounded-xl p-8 hover:border-[#ccff00]/20 hover:shadow-[0_0_30px_rgba(204,255,0,0.06)] hover:-translate-y-1 transition-all">
              <div className="w-12 h-12 rounded-lg bg-[#3131c0]/20 flex items-center justify-center text-2xl mb-5">🎯</div>
              <h3 className="font-grotesk text-lg font-semibold text-foreground mb-2">Segmentação Cirúrgica</h3>
              <p className="text-foreground/70 text-sm leading-relaxed">Encontramos seu cliente ideal — onde ele está, no momento exato de compra. Sem desperdício de verba, só resultado.</p>
            </div>
            {/* Card 3 */}
            <div className="bg-surface-low border border-foreground/5 rounded-xl p-8 hover:border-[#ccff00]/20 hover:shadow-[0_0_30px_rgba(204,255,0,0.06)] hover:-translate-y-1 transition-all">
              <div className="w-12 h-12 rounded-lg bg-[#6900b3]/20 flex items-center justify-center text-2xl mb-5">🔍</div>
              <h3 className="font-grotesk text-lg font-semibold text-foreground mb-2">Monitoramento 24/7</h3>
              <p className="text-foreground/70 text-sm leading-relaxed">Acesso a alertas e especialistas disponíveis para suas campanhas digitais em tempo real, todos os dias.</p>
            </div>
            {/* Card 4 */}
            <div className="bg-surface-low border border-foreground/5 rounded-xl p-8 hover:border-[#ccff00]/20 hover:shadow-[0_0_30px_rgba(204,255,0,0.06)] hover:-translate-y-1 transition-all">
              <div className="w-12 h-12 rounded-lg bg-[#ccff00]/10 flex items-center justify-center text-2xl mb-5">⚡</div>
              <h3 className="font-grotesk text-lg font-semibold text-foreground mb-2">Maior Alcance</h3>
              <p className="text-foreground/70 text-sm leading-relaxed">O tráfego pago coloca sua marca na frente de quem ainda não te conhece. Expanda além da sua audiência atual.</p>
            </div>
            {/* Card 5 */}
            <div className="bg-surface-low border border-foreground/5 rounded-xl p-8 hover:border-[#ccff00]/20 hover:shadow-[0_0_30px_rgba(204,255,0,0.06)] hover:-translate-y-1 transition-all">
              <div className="w-12 h-12 rounded-lg bg-[#3131c0]/20 flex items-center justify-center text-2xl mb-5">🔁</div>
              <h3 className="font-grotesk text-lg font-semibold text-foreground mb-2">Remarketing Inteligente</h3>
              <p className="text-foreground/70 text-sm leading-relaxed">Recuperamos visitantes que não converteram com anúncios personalizados e estratégias de retargeting avançadas.</p>
            </div>
            {/* Card 6 */}
            <div className="bg-surface-low border border-foreground/5 rounded-xl p-8 hover:border-[#ccff00]/20 hover:shadow-[0_0_30px_rgba(204,255,0,0.06)] hover:-translate-y-1 transition-all">
              <div className="w-12 h-12 rounded-lg bg-[#6900b3]/20 flex items-center justify-center text-2xl mb-5">📊</div>
              <h3 className="font-grotesk text-lg font-semibold text-foreground mb-2">Análise de Dados</h3>
              <p className="text-foreground/70 text-sm leading-relaxed">Tomamos decisões baseadas em dados concretos — não em achismos. Relatórios claros, transparentes e acionáveis.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="services" className="py-24 bg-background">
        <div className="container mx-auto px-6">
          <div className="flex flex-col items-center text-center mb-16">
            ...
            <p className="text-foreground/70 mt-4 max-w-2xl">Do diagnóstico à escala, gerenciamos todo o seu ecossistema de anúncios pagos.</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6">
            {/* Serviço 1 - Destaque */}
            <div className="bg-surface-low border border-[#ccff00]/25 shadow-[0_0_30px_rgba(204,255,0,0.08)] rounded-xl p-8 relative overflow-hidden group">
              ...
              <h3 className="font-grotesk text-xl font-bold text-foreground mb-2">Gestão de Google Ads</h3>
              <p className="text-foreground/70 text-sm leading-relaxed mb-6">Capturamos a intenção de compra no exato momento em que o usuário pesquisa. Seus anúncios aparecem no topo para quem já quer comprar.</p>
              <ul className="flex flex-col gap-3">
                {['Pesquisa, Display, Shopping e YouTube Ads', 'Palavras-chave de alta conversão selecionadas cirurgicamente', 'Lances automáticos com Machine Learning', 'Relatórios mensais detalhados de performance'].map((item, i) => (
                  <li key={i} className="flex gap-3 text-foreground/70 text-sm"><span className="text-[#ccff00]">↗</span> {item}</li>
                ))}
              </ul>
            </div>

            {/* Serviço 2 */}
            <div className="bg-surface-low border border-foreground/5 rounded-xl p-8 hover:border-[#ccff00]/15 hover:shadow-[0_0_24px_rgba(204,255,0,0.05)] transition-all">
              <div className="text-[#ccff00] font-grotesk text-[0.7rem] font-bold tracking-widest uppercase mb-4">Meta Ads</div>
              <h3 className="font-grotesk text-xl font-bold text-foreground mb-2">Facebook & Instagram Ads</h3>
              <p className="text-foreground/70 text-sm leading-relaxed mb-6">Engajamos usuários no Instagram e Facebook com criativos persuasivos e segmentação de público avançada para escalar suas conversões.</p>
              <ul className="flex flex-col gap-3">
            ...
            <div className="bg-surface-low border border-foreground/5 rounded-xl p-8 hover:border-[#ccff00]/15 hover:shadow-[0_0_24px_rgba(204,255,0,0.05)] transition-all">
              ...
              <h3 className="font-grotesk text-xl font-bold text-foreground mb-2">Estratégias de Remarketing</h3>
              <p className="text-foreground/70 text-sm leading-relaxed mb-6">Recuperamos carrinhos abandonados, reengajamos visitantes e fidelizamos clientes com campanhas de retargeting ultra-personalizadas.</p>
              <ul className="flex flex-col gap-3">
            ...
            <div className="bg-surface-low border border-foreground/5 rounded-xl p-8 hover:border-[#ccff00]/15 hover:shadow-[0_0_24px_rgba(204,255,0,0.05)] transition-all">
              ...
              <h3 className="font-grotesk text-xl font-bold text-foreground mb-2">Mentoria Estratégica Individual</h3>
              <p className="text-foreground/70 text-sm leading-relaxed mb-6">100% personalizada para o seu modelo de negócio. Chamadas semanais, revisão de contas e implementação de táticas exclusivas de escala.</p>
              <ul className="flex flex-col gap-3">
      ...
      {/* CAPTAÇÃO SECTION */}
      <section id="captacao" className="py-24 bg-surface-lowest">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-foreground/70 text-lg max-w-2xl mx-auto">Construímos sua base de clientes com captação qualificada, público-alvo preciso e comunicação direta via WhatsApp.</p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="flex flex-col gap-6">
              {[
                ...
                <div key={i} className="bg-surface-low border border-foreground/5 border-l-[3px] border-l-[#ccff00] rounded-r-lg p-6">
                  <h4 className="font-grotesk font-semibold text-foreground mb-2">{item.icon} {item.title}</h4>
                  <p className="text-foreground/70 text-sm leading-relaxed">{item.desc}</p>
                </div>
              ))}
            </div>

            <div className="bg-surface-low border border-foreground/5 rounded-xl p-8 lg:p-10">
              <h3 className="font-grotesk text-2xl font-bold text-foreground mb-8">Mentoria de <span className="text-[#ccff00]">Captação</span></h3>
              <div className="flex flex-col">
                {[
                  ...
                  <div key={i} className="flex gap-4 py-6 border-b border-foreground/5 last:border-0 last:pb-0 first:pt-0">
                    ...
                    <div>
                      <h5 className="font-grotesk font-semibold text-foreground mb-1">{step.title}</h5>
      ...
      {/* AUTOMAÇÃO WHATSAPP */}
      <section id="automacao" className="py-24 bg-background">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-foreground/70 text-lg max-w-2xl mx-auto">Automatize o atendimento, qualifique leads 24h por dia e aumente drasticamente sua taxa de conversão.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-surface-low border border-foreground/5 rounded-xl p-8 text-center hover:border-[#c0c1ff]/20 hover:-translate-y-1 transition-all">
                <div className="font-grotesk text-4xl font-bold text-[#c0c1ff] mb-4">{card.num}</div>
                <h4 className="font-grotesk font-semibold text-foreground mb-2">{card.title}</h4>
      ...
      {/* ROADMAP */}
      <section id="roadmap" className="py-24 bg-surface-lowest overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-foreground/70 text-lg max-w-2xl mx-auto">Um processo estruturado e comprovado para levar seu negócio do diagnóstico à dominância de mercado.</p>
          </div>
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            {[
              ...
              <div key={i} className={`flex flex-col md:flex-row gap-0 mb-12 items-start relative pl-[4.5rem] md:pl-0 ${i % 2 === 0 ? '' : 'md:flex-row-reverse'}`}>
                <div className={`w-full md:w-[calc(50%-2rem)] bg-surface-low border border-foreground/5 rounded-xl p-7 relative ${i % 2 === 0 ? 'md:mr-auto' : 'md:ml-auto'}`}>
                  <div className="font-grotesk text-[0.7rem] font-bold tracking-widest uppercase text-[#ccff00] mb-2">{item.num}</div>
                  <h3 className="font-grotesk font-semibold text-foreground text-lg mb-2">{item.title}</h3>
                  <p className="text-foreground/70 text-sm leading-relaxed">{item.desc}</p>
                </div>
                {/* Dot */}
              ...
              <div className="grid grid-cols-2 gap-8">
                {[
                  ...
                  <div key={i} className="border-l-2 border-[#ccff00] pl-5">
                    <div className="font-grotesk text-3xl font-bold text-foreground">{stat.num}</div>
                    <div className="font-grotesk text-[0.65rem] font-bold tracking-widest uppercase text-foreground/70 mt-1">{stat.lbl}</div>
                  </div>
                ))}
              </div>
            </div>

            <div className="bg-surface-high border border-foreground/5 rounded-xl p-8 flex flex-col gap-4">
              <div className="font-grotesk text-[0.7rem] font-bold tracking-widest uppercase text-foreground/70 mb-2">Crescimento de ROAS — Últimos 6 Meses</div>
              <div className="flex items-end gap-2 h-40">
                {[
                  ...
                  <div key={i} className={`flex-1 rounded-t-md relative ${bar.highlight ? 'bg-gradient-to-t from-[#86bb00] to-[#ccff00] shadow-[0_-8px_20px_rgba(204,255,0,0.3)]' : 'bg-gradient-to-t from-[#3131c0] to-[#c0c1ff]'}`} style={{ height: bar.height }}>
                    <span className="absolute -top-6 left-1/2 -translate-x-1/2 font-grotesk text-[0.6rem] font-bold text-foreground/70 whitespace-nowrap">{bar.label}</span>
              ...
              <div className="mt-6 flex flex-col gap-3">
                <div className="flex justify-between text-sm"><span className="text-foreground/70">Taxa de conversão média</span><span className="text-[#ccff00] font-grotesk font-bold">+87%</span></div>
                <div className="flex justify-between text-sm"><span className="text-foreground/70">Custo por Lead reduzido</span><span className="text-[#ccff00] font-grotesk font-bold">-43%</span></div>
                <div className="flex justify-between text-sm"><span className="text-foreground/70">Leads qualificados gerados</span><span className="text-[#ccff00] font-grotesk font-bold">+215%</span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="tools" className="py-24 bg-surface-lowest">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-foreground/70 text-lg max-w-2xl mx-auto">Usamos as melhores ferramentas do mercado para maximizar seus resultados.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-surface-low border border-foreground/5 rounded-xl p-6 text-center hover:border-[#c0c1ff]/20 transition-all">
                <div className="text-3xl mb-4">{tool.icon}</div>
                <h4 className="font-grotesk font-semibold text-foreground mb-2">{tool.title}</h4>
                <p className="text-foreground/70 text-sm leading-relaxed">{tool.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-3xl mx-auto flex flex-col gap-4">
            {[
              ...
              <details key={i} className="group bg-surface-low border border-foreground/5 rounded-xl overflow-hidden open:border-[#ccff00]/20 transition-all" open={i === 0}>
                <summary className="flex justify-between items-center p-6 cursor-pointer list-none font-grotesk font-semibold text-foreground hover:bg-white/[0.02]">
                  {faq.q}
                  <span className="text-[#ccff00] text-2xl font-light group-open:rotate-45 transition-transform duration-300">+</span>
                </summary>
                <div className="px-6 pb-6 pt-2 text-foreground/70 text-sm leading-relaxed border-t border-foreground/5 mx-6 mt-0">
                  {faq.a}
                </div>
              </details>
            ))}
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto bg-[#ccff00] rounded-3xl p-12 md:p-20 text-center relative overflow-hidden shadow-[0_30px_80px_rgba(204,255,0,0.2)]">
            ...
            <Link 
              ...
              target="_blank"
              className="inline-flex items-center gap-3 bg-surface-lowest text-foreground font-grotesk font-bold uppercase tracking-widest px-10 py-5 rounded-full hover:scale-105 hover:shadow-2xl transition-all"
            >
